...
Главный экран на ПК.  
Здесь показывается состояние службы, сетевые параметры и кнопка для показа QR-кода, через который привязывается телефон.

![Главный экран на ПК](./docs/screenshots/desktop-main.png)

Главный экран Android-приложения.  
На этом экране отображается привязанный компьютер и быстрый переход к управлению или настройкам.

![Главный экран Android](./docs/screenshots/android-home.jpg)

Экран настроек на Android.  
Здесь задаются внешний IP или DDNS, локальный IP, имя ПК, а также включаются локальный режим и Wake-on-LAN.

![Настройки Android](./docs/screenshots/android-settings.jpg)

Встроенный гайд на Android.  
Это отдельный экран с визуальной инструкцией по локальной сети, внешнему доступу и базовой сетевой настройке.

![Гайд на Android](./docs/screenshots/android-guide.jpg)
...
- Android: [PC.Remote.NET.apk](https://github.com/RoXy228/PC-Remote-NET/releases/download/v0.1.0/PC.Remote.NET.apk)
- Windows: [PCRemoteSetup.exe](https://github.com/RoXy228/PC-Remote-NET/releases/download/v0.1.0/PCRemoteSetup.exe)
...
Main Windows screen.  
This screen shows the service status, network information, and the QR action used to link the phone.

![Main Windows screen](./docs/screenshots/desktop-main.png)

Main Android screen.  
This is the starting screen where the linked PC is shown and the user can move to control or settings.

![Main Android screen](./docs/screenshots/android-home.jpg)

Android settings screen.  
This is where the user enters external IP or DDNS, local IP, PC name, and enables local mode and Wake-on-LAN.

![Android settings screen](./docs/screenshots/android-settings.jpg)

Built-in Android guide.  
This screen explains local mode, internet mode, and the basic network setup flow in a visual way.

![Built-in Android guide](./docs/screenshots/android-guide.jpg)
